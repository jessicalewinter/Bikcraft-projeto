...
Visibility.onVisible(function(){
    ...
    setTimeout(function(){
        $(".intro .quote-externo").addClass("animated fadeInDown");
    },800);
     setTimeout(function(){
    ...
    setTimeout(function(){
        $(".intro_sobre h1").addClass("animated fadeInDown");
    },400);
    setTimeout(function(){
        $(".intro_sobre p").addClass("animated fadeInDown");
    },800);
    setTimeout(function(){
        $(".animar-interno").addClass("animated fadeInDown");
    },1200);
    setTimeout(function(){
        $(".portfolio .animar-interno").addClass("animated fadeInDown");
    },1600);
});
